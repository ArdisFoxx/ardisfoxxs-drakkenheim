...
<!--- ![Latest Release Download Count](https://img.shields.io/github/downloads/ArdisFoxx/ardisfoxxs-drakkenheim/latest/module.zip) -->

<!--- Forge Bazaar Install % Badge -->
<!--- replace <your-module-name> with the `name` in your manifest -->
<!--- ![Forge Installs](https://img.shields.io/badge/dynamic/json?label=Forge%20Installs&query=package.installs&suffix=%25&url=https%3A%2F%2Fforge-vtt.com%2Fapi%2Fbazaar%2Fpackage%2F<ardisfoxxs-drakkenheim>&colorB=4aa94a) -->
...
7. You can use the url `https://github.com/ArdisFoxx/ardisfoxxs-drakkenheim/releases/latest/download/module.json` to refer to the manifest.
